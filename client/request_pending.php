            ...
            <div class="col-10">
                <div class="border-bottom border-top border-primary bg-light py-5 px-4">
                    ...
                    $query = "
                            ...
                            AND crf.status = 'pending' AND crf.client_id = $user_id
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($row['status'] === 'cancelled'): ?>
                                                    <a href="#" class="btn btn-danger btn-sm disabled" aria-disabled="true">Cancelled</a>
                                                <?php else: ?>
                                                    <a href="functions/cancel_request.php?id=<?php echo $row['id']; ?>"
