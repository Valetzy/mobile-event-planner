        ...
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">Pending Request</h3>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                $query = "SELECT u.full_name, u.profile_pic, u.user_id , ogr.status, ogr.orga_request_id
                                        ...
                                        WHERE ogr.status = 'request' AND ogr.supplier_id = '" . $_SESSION['id'] . "'";
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                if ($status === 'request') {
                                                    ...
                                                    echo '<form action="functions/confirm.php" method="post">
                                                            ...
                                                            <button class="btn btn-success m-3" type="submit">Confirm</button>
                                                        </form>';

                                                    echo '<form action="functions/deny.php" method="post">
                                                                <input type="hidden" name="deny" value="deny">
                                                                <input type="hidden" name="orga_id" value="' . htmlspecialchars($row['orga_request_id']) . '">
                                                                <button class="btn btn-danger m-3" type="submit">Deny</button>
                                                            </form>';
                                                } 
