                            ...
                            <div class="row g-4 form">
                                ...
                                <div class="col-lg-8 col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" disabled id="floatingInput" name="full_name"
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" disabled id="floatingInput" name="relationship" value="<?php echo htmlspecialchars($row['relationship']); ?>"
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="number" class="form-control" disabled id="floatingInput" name="contact_number"
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" disabled id="floatingInput" name="address"
                                ...
                                <div class="col-lg-12 col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" disabled id="floatingInput" name="baby_name"
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="form-floating mb-3">
                                        <select class="form-control" disabled id="floatingGender" name="gender" required>
