...
?>
<!-- Your additional organizer page content goes here -->
        ...
        <main class="app-main"> <!--begin::App Content Header-->
            <div class="app-content-header"> <!--begin::Container-->
                <div class="container-fluid"> <!--begin::Row-->
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">organizer pending</h3>
                        </div>
                        <div class="col-sm-6">
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        echo '<tr class="align-middle">
                                            ...
                                            <td>
                                                <a href="function/organizer_approved.php?id=' . htmlspecialchars($row['user_id']) . '" class="btn btn-success btn-sm">Approve</a>
                                                <a href="function/organizer_reject.php?id=' . htmlspecialchars($row['user_id']) . '" class="btn btn-danger btn-sm">Reject</a>
                                            </td>
                                        </tr>';
                                        $counter++;
                                    }
